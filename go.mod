module github.com/neumathe/simple-admin-core
...
require (
	...
	github.com/neumathe/simple-admin-common v1.8.0
...
replace github.com/suyuan32/simple-admin-job v1.6.2 => ../simple-admin-job

replace github.com/zeromicro/go-zero v1.8.0 => ../simple-admin-tools
