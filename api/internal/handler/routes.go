...
import (
	...
	api "github.com/neumathe/simple-admin-core/api/internal/handler/api"
	authority "github.com/neumathe/simple-admin-core/api/internal/handler/authority"
	base "github.com/neumathe/simple-admin-core/api/internal/handler/base"
	captcha "github.com/neumathe/simple-admin-core/api/internal/handler/captcha"
	configuration "github.com/neumathe/simple-admin-core/api/internal/handler/configuration"
	department "github.com/neumathe/simple-admin-core/api/internal/handler/department"
	dictionary "github.com/neumathe/simple-admin-core/api/internal/handler/dictionary"
	dictionarydetail "github.com/neumathe/simple-admin-core/api/internal/handler/dictionarydetail"
	emaillog "github.com/neumathe/simple-admin-core/api/internal/handler/emaillog"
	emailprovider "github.com/neumathe/simple-admin-core/api/internal/handler/emailprovider"
	mcmsbanner "github.com/neumathe/simple-admin-core/api/internal/handler/mcmsbanner"
	mcmsnotice "github.com/neumathe/simple-admin-core/api/internal/handler/mcmsnotice"
	menu "github.com/neumathe/simple-admin-core/api/internal/handler/menu"
	messagesender "github.com/neumathe/simple-admin-core/api/internal/handler/messagesender"
	oauthprovider "github.com/neumathe/simple-admin-core/api/internal/handler/oauthprovider"
	pdftasklog "github.com/neumathe/simple-admin-core/api/internal/handler/pdftasklog"
	position "github.com/neumathe/simple-admin-core/api/internal/handler/position"
	publicapi "github.com/neumathe/simple-admin-core/api/internal/handler/publicapi"
	publicuser "github.com/neumathe/simple-admin-core/api/internal/handler/publicuser"
	role "github.com/neumathe/simple-admin-core/api/internal/handler/role"
	smslog "github.com/neumathe/simple-admin-core/api/internal/handler/smslog"
	smsprovider "github.com/neumathe/simple-admin-core/api/internal/handler/smsprovider"
	task "github.com/neumathe/simple-admin-core/api/internal/handler/task"
	tasklog "github.com/neumathe/simple-admin-core/api/internal/handler/tasklog"
	token "github.com/neumathe/simple-admin-core/api/internal/handler/token"
	user "github.com/neumathe/simple-admin-core/api/internal/handler/user"
			...
			[]rest.Route{
				{
					Method:  http.MethodPost,
					Path:    "/pdflog",
					Handler: pdftasklog.GetPdfTaskInfoHandler(serverCtx),
				},
				{
					Method:  http.MethodPost,
					Path:    "/pdflog/list",
					Handler: pdftasklog.GetPdfTaskListHandler(serverCtx),
				},
			}...,
		),
		rest.WithJwt(serverCtx.Config.Auth.AccessSecret),
