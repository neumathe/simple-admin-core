...
const (
	...
	Core_BlockUserTokenBySource_FullMethodName              = "/core.Core/BlockUserTokenBySource"
...
func (c *coreClient) BlockUserTokenBySource(ctx context.Context, in *BlockUserTokenBySourceReq, opts ...grpc.CallOption) (*BaseResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BaseResp)
	err := c.cc.Invoke(ctx, Core_BlockUserTokenBySource_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coreClient) GetUserByEmail(ctx context.Context, in *EmailReq, opts ...grpc.CallOption) (*UserInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserInfo)
	err := c.cc.Invoke(ctx, Core_GetUserByEmail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coreClient) GetUserByPhone(ctx context.Context, in *PhoneReq, opts ...grpc.CallOption) (*UserInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserInfo)
	err := c.cc.Invoke(ctx, Core_GetUserByPhone_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CoreServer interface {
	...
	// group: token
	BlockUserTokenBySource(context.Context, *BlockUserTokenBySourceReq) (*BaseResp, error)
	// group: token
...
func (UnimplementedCoreServer) BlockUserTokenBySource(context.Context, *BlockUserTokenBySourceReq) (*BaseResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BlockUserTokenBySource not implemented")
}
...
func (UnimplementedCoreServer) GetUserByEmail(context.Context, *EmailReq) (*UserInfo, error) {
...
func _Core_BlockUserTokenBySource_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BlockUserTokenBySourceReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoreServer).BlockUserTokenBySource(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Core_BlockUserTokenBySource_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServer).BlockUserTokenBySource(ctx, req.(*BlockUserTokenBySourceReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Core_GetUserByEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Core_GetUserByEmail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServer).GetUserByEmail(ctx, req.(*EmailReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Core_GetUserByPhone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PhoneReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoreServer).GetUserByPhone(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Core_GetUserByPhone_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServer).GetUserByPhone(ctx, req.(*PhoneReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Core_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BlockUserTokenBySource",
			Handler:    _Core_BlockUserTokenBySource_Handler,
		},
		{
